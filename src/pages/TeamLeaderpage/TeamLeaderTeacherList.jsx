...
const TeamLeaderTeacherList = () => {
    ...
    useEffect(() => {
        ...
        axios
          .get(`${import.meta.env.VITE_local_host}/auth/leader-teacher-list`, {
            headers: {
            ...
            <CardBody className="overflow-x-scroll px-0 pt-0 pb-2">
                {loading ? ( // Show spinner while loading is true
                  <div className="flex justify-center items-center py-6">
                    <Spinner color="blue-gra" className="h-8 w-8 text-blue-500" />
                  </div>
                ) : (
...
export default TeamLeaderTeacherList;
