...
const ALlActiveForSeniorLeader = () => {
    const [activeStudents, setActiveStudents] = useState([]);

    useEffect(() => {
      const token = localStorage.getItem("token");
      axios
        .get(`${import.meta.env.VITE_local_host}/auth/seniorLeaderMappStudent`, {
          headers: {
            Authorization: `Bearer ${token}`,
          },
        })
        .then((res) => {
          console.log(res.data.data.activeStudents);
          if (Array.isArray(res.data.data.activeStudents)) {
...
export default ALlActiveForSeniorLeader;